...
export async function GET() {
  try {
    ...
    if (!resolved.parsha) return error("No parsha found for today", 404);
    ...
    if (!schedule) return error("Chumash schedule not found", 404);
    ...
    console.error("Chumash today error:", e);
